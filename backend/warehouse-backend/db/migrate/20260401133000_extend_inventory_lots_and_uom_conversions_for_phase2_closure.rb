# This migration comes from cats_warehouse (originally 20260401133000)
class ExtendInventoryLotsAndUomConversionsForPhase2Closure < ActiveRecord::Migration[7.0]
  def change
