module Cats
  module Warehouse
    class LocationsController < BaseController
      ...
      def zones
        region = params[:region_id].present? ? Cats::Core::Location.find(params[:region_id]) : addis_region
    ...
    def stores
      ...
      def addis_region
        Cats::Core::Location.find_by!(location_type: Cats::Core::Location::REGION, name: "Addis Ababa")
      end
